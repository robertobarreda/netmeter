/*
 *   $Id: nmtaskstat.cpp,v 1.1.1.1 2007-05-26 17:41:22 rserral Exp $
 *
...
NMTaskStat::NMTaskStat( int testid, NMString plugin, NMString xmlparam, const char *name,  NMParent *parent)
 : NMTask( testid, plugin, xmlparam, NMDateTime(), name, parent)
{
}


NMTaskStat::~NMTaskStat()
{
}
