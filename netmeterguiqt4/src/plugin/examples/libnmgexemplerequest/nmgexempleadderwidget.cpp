...
NMGExempleAdderWidget::NMGExempleAdderWidget ( NMGISender *s, QWidget *parent, const char *name )
		: QWidget ( parent )
{
	setObjectName ( name );
	setupUi ( this );
...
NMGExempleAdderWidget::~NMGExempleAdderWidget()
{}

void NMGExempleAdderWidget::buttonAddClicked()
{
	...
	sender->sendCommand ( Start, xmlMessage );

}

#include "nmgexempleadderwidget.moc"
